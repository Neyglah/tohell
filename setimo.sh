...
#
# --------------------------------------------------
# Este program ira verificar o valor da variável NUMERO, enquanto o valor da variável não for  10, e# le irá mostar a mensagem na tela que o valor é menor que 10 e mostrara o valor da variável. Quando# o valor atingir 10 o programa será finalizado
#
# Exemplo de execução:
#
# $ ./setimo.sh 
